...
class quiz_overview_report extends attempts_report {
     ...
     *      See get_latest_question_in_slot.
     */
    ...
    public function regrade_attempt($attempt, $dryrun = false, $slots = null): array {
        ...
        foreach ($slots as $slot) {
            ...
            $otherquestionversion = qbank_helper::get_latest_question_in_slot($this->structureforregrade,
                $this->newquestionidsforold, $attempt, $this->context, $slot, $quba);
