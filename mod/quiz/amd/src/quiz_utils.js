...
const slot = {
    ...
    CONSTANTS: {
        SLOTIDPREFIX: 'slot-',
        QUESTION: getString('question', 'moodle')
    },
    SELECTORS: {
        SLOT: 'li.slot',
     ...
     * @param slotComponent {HTMLElement} The component Node.
     ...
     *
     * @method getId
     * @param slot {HTMLElement} The slot to find an ID for.
     ...
     *
     * @method getName
     * @param slot {HTMLElement} The slot to find a name for.
     ...
     *
     * @method getNumber
     * @param slot {HTMLElement} The slot to find the number for.
     ...
     *
     * @method getPrevious
     * @param slot {HTMLElement} Slot node
...
const page = {
     ...
     * @param slot {HTMLElement} The component Node.
    ...
    const numberElement = page.querySelector(this.SELECTORS.NUMBER);
        if (numberElement) {
            numberElement.textContent = getString('page', 'moodle') + ' ' + number;
        }
    },
     ...
     *
     * @method isEmpty
     * @param page {HTMLElement} Page node
     * @return boolean
     */
